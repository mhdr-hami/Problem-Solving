...
2. **Remeber** the similar problem 💡 **Remember** the idea 💡 <br> This is the key step that helps you get the `Accept `:white_check_mark:, and get better at problem solving over time. Once you finish reading the description, start thinking about the questions you have solved before. Try to remember how you solved them. Remember the idea you used and try your best to say why this question needs the similar idea in one sentence. 
